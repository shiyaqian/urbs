...
class eval:
	...
	def input_widgets(self):
		...
		self.filename_quote = """1Node_mitW.xlsx"""
		...
		self.pro_quote = """Gas Engine CHP, MCFC_H2, PEMFC_H2, AFC_H2, SOFC_H2, MC Fuel Cell CHP, PEM Fuel Cell CHP, AL Fuel Cell CHP"""
		...
		self.proch_quote = """Reformer"""
		self.proch.insert(END, self.proch_quote)
